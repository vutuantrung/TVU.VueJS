const app = Vue.createApp({
  ...
  watch: {
    name(newValue, oldValue) {
      // whenever name in data property change, this code will be executed
      this.fullName = newValue + ' ' + 'VU Tuan';
    },
  },
  methods: {
    outputFullName() {
...
// NOTE a watcher is basically a function you can tell Vue to execute, when one of its dependencies changed.
